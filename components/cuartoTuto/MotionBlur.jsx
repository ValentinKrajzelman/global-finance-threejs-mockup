...
//crea un nuevo effecto extendiendo la clase de Effect, y usa el shader de arriba
class MotionBlurImpl extends Effect {
  ...
  update(renderer, inputBuffer, deltaTime) {
    //aca toma el valor turbo y pone como atributo del motionblur
    this.uniforms.get('strength').value = turbo;
  }
}

//exporta el efecto como una primitiva que puede ser usada como clase 
